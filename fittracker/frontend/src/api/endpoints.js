...
export const itemsAPI = {
  ...
  getExercises: (id) => api.get(`/items/${id}/exercises/`),
  addExercise: (id, data) => api.post(`/items/${id}/exercises/`, data),
  deleteExercise: (id, exId) => api.delete(`/items/${id}/exercises/${exId}/`),
