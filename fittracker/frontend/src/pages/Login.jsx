    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">Войдите в {config.projectName}</p>
        </div>
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          {location.state?.registered && <div className="bg-emerald-50 text-emerald-700 p-3 rounded-xl mb-5 text-sm border border-emerald-100">Регистрация успешна! Теперь войдите.</div>}
