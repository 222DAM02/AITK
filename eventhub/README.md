...
**Площадка мероприятий с регистрацией участников**
...
| Роли | User, Admin |
| Сущность | Событие (CRUD) |
| Регистрация | Запись на мероприятие, список участников |
| AI | GPT-3.5 + RAG с embeddings |
| Данные | Nager.Date API — праздники и выходные 10 стран |
| UI | Bottom-навигация на мобильном, избранное (★) |
