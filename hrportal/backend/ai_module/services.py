...
SYSTEM_PROMPT = "Ты HR-специалист. Помогай с управлением персоналом, отпусками, KPI и трудовым правом. Используй базу знаний."
...
URLS = [
    ('https://en.wikipedia.org/wiki/Human_resource_management','hrm'),
    ('https://en.wikipedia.org/wiki/Performance_appraisal','performance'),
    ('https://en.wikipedia.org/wiki/Employee_engagement','engagement'),
    ('https://en.wikipedia.org/wiki/Onboarding','onboarding'),
    ('https://en.wikipedia.org/wiki/Annual_leave','leave'),
    ('https://en.wikipedia.org/wiki/Labour_law','labour_law'),
    ('https://en.wikipedia.org/wiki/Occupational_burnout','burnout'),
    ('https://en.wikipedia.org/wiki/Organizational_culture','culture'),
    ('https://en.wikipedia.org/wiki/Remote_work','remote'),
    ('https://en.wikipedia.org/wiki/Salary','salary'),
]
def fetch_hr_data() -> int:
