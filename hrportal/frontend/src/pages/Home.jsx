  ...
  return (<div>
    ...
    <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-24">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {[
          { icon: '👥', title: 'Управление персоналом', desc: 'Сотрудники, отделы, должности и зарплаты' },
          { icon: '🏖️', title: 'Отпуска и больничные', desc: 'Заявки на отпуск с одобрением и отклонением' },
