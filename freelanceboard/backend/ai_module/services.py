...
SYSTEM_PROMPT = "Ты эксперт по фрилансу и IT-карьере. Помогай с поиском заказов, оценкой проектов и развитием навыков. Используй базу знаний."
...
URLS = [
    ...
    ('https://en.wikipedia.org/wiki/Web_development','web_dev'),
    ('https://en.wikipedia.org/wiki/Mobile_app_development','mobile'),
    ('https://en.wikipedia.org/wiki/User_experience_design','ux'),
    ('https://en.wikipedia.org/wiki/Digital_marketing','marketing'),
    ('https://en.wikipedia.org/wiki/Copywriting','copywriting'),
    ('https://en.wikipedia.org/wiki/DevOps','devops'),
    ('https://en.wikipedia.org/wiki/Data_science','data_science'),
    ('https://en.wikipedia.org/wiki/Software_project_management','pm'),
    ('https://en.wikipedia.org/wiki/Non-disclosure_agreement','nda'),
]
def fetch_freelance_data() -> int:
