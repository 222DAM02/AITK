  ...
  return (<div>
    ...
    <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-24">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {[
          { icon: '📝', title: 'Заказы и отклики', desc: 'Публикуйте заказы, получайте отклики от фрилансеров' },
          { icon: '🤖', title: 'AI + RAG', desc: config.aiFeature.description },
          { icon: '💰', title: 'Бюджеты и дедлайны', desc: 'Фиксированная или почасовая оплата, контроль сроков' },
        ].map((f) => (
