...
export const itemsAPI = {
  ...
  getProposals: (id) => api.get(`/items/${id}/proposals/`),
  addProposal: (id, data) => api.post(`/items/${id}/proposals/`, data),
  updateProposal: (id, propId, data) => api.patch(`/items/${id}/proposals/${propId}/`, data),
}
