...
SYSTEM_PROMPT = "Ты эксперт по складскому учёту. Помогай с инвентаризацией, логистикой и управлением запасами. Используй базу знаний."
...
URLS = [
    ('https://en.wikipedia.org/wiki/Inventory_management','inventory'),
    ('https://en.wikipedia.org/wiki/Supply_chain_management','supply_chain'),
    ('https://en.wikipedia.org/wiki/Just-in-time_manufacturing','jit'),
    ('https://en.wikipedia.org/wiki/Warehouse','warehouse'),
    ('https://en.wikipedia.org/wiki/Barcode','barcode'),
    ('https://en.wikipedia.org/wiki/Safety_stock','safety_stock'),
    ('https://en.wikipedia.org/wiki/Economic_order_quantity','eoq'),
    ('https://en.wikipedia.org/wiki/ABC_analysis','abc'),
    ('https://en.wikipedia.org/wiki/Logistics','logistics'),
    ('https://en.wikipedia.org/wiki/FIFO_and_LIFO_accounting','fifo'),
]
def fetch_inventory_data() -> int:
