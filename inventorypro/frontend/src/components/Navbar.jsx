...
export default function Navbar() {
  ...
  return (<>
    <div className="lg:hidden flex items-center justify-between h-14 px-4 border-b border-current/10 sticky top-0 z-50 bg-orange-50">
    ...
    <div className="hidden lg:flex flex-col fixed left-0 top-0 h-screen w-60 border-r border-current/10 z-40 bg-orange-50">
      {sideContent}
    </div>
