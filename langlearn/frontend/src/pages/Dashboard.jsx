...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    itemsAPI.myStats().then(({ data }) => setStats(data)).catch(() => {})
  }, [])
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-fuchsia-50 rounded-2xl p-6 border border-fuchsia-200">
          <p className="text-sm text-gray-500 mb-1">Квизы пройдено</p>
          <p className="text-3xl font-bold text-fuchsia-600">{stats?.quizzes_completed || 0}</p>
        </div>
