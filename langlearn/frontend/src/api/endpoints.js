...
export const itemsAPI = {
  ...
  getWords: (id) => api.get(`/items/${id}/words/`),
  addWord: (id, data) => api.post(`/items/${id}/words/`, data),
  deleteWord: (id, wordId) => api.delete(`/items/${id}/words/${wordId}/`),
  updateMastery: (id, wordId, mastery) => api.patch(`/items/${id}/words/${wordId}/mastery/`, { mastery }),
  getQuiz: (id) => api.get(`/items/${id}/quiz/`),
  finishQuiz: (id, data) => api.post(`/items/${id}/finish-quiz/`, data),
...
export const aiAPI = {
  ...
  fetchData: (words) => api.post('/ai/fetch-data/', { words }),
