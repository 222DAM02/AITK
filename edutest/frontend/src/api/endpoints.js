...
export const itemsAPI = {
  ...
  getQuestions: (id) => api.get(`/items/${id}/questions/`),
  addQuestion: (id, data) => api.post(`/items/${id}/questions/`, data),
  deleteQuestion: (id, qid) => api.delete(`/items/${id}/questions/${qid}/`),
  submitTest: (id, data) => api.post(`/items/${id}/submit/`, data),
