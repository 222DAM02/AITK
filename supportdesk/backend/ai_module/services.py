...
SYSTEM_PROMPT = "Ты специалист технической поддержки. Помогай с решением тикетов, SLA и ITIL-практиками. Используй базу знаний."
...
URLS = [
    ('https://en.wikipedia.org/wiki/ITIL','itil'),
    ('https://en.wikipedia.org/wiki/Help_desk','helpdesk'),
    ('https://en.wikipedia.org/wiki/Service-level_agreement','sla'),
    ('https://en.wikipedia.org/wiki/Incident_management_(ITSM)','incident'),
    ('https://en.wikipedia.org/wiki/Problem_management','problem'),
    ('https://en.wikipedia.org/wiki/Change_management_(ITSM)','change'),
    ('https://en.wikipedia.org/wiki/IT_service_management','itsm'),
    ('https://en.wikipedia.org/wiki/Technical_support','tech_support'),
    ('https://en.wikipedia.org/wiki/Escalation_(business)','escalation'),
    ('https://en.wikipedia.org/wiki/Knowledge_base','knowledge_base'),
]
def fetch_support_data() -> int:
