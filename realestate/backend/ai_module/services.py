...
SYSTEM_PROMPT = "Ты риелтор и эксперт по недвижимости. Помогай с оценкой, выбором объектов и юридическими вопросами. Используй базу знаний."
...
URLS = [
    ('https://en.wikipedia.org/wiki/Real_estate','general'),
    ('https://en.wikipedia.org/wiki/Mortgage_loan','mortgage'),
    ('https://en.wikipedia.org/wiki/Real_estate_appraisal','appraisal'),
    ('https://en.wikipedia.org/wiki/Apartment','apartment'),
    ('https://en.wikipedia.org/wiki/Condominium','condo'),
    ('https://en.wikipedia.org/wiki/Lease','lease'),
    ('https://en.wikipedia.org/wiki/Property_tax','tax'),
    ('https://en.wikipedia.org/wiki/Real_estate_investing','investing'),
    ('https://en.wikipedia.org/wiki/Gentrification','gentrification'),
    ('https://en.wikipedia.org/wiki/Smart_home','smart_home'),
]
def fetch_realestate_data() -> int:
