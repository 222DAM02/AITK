...
export default function Navbar() {
  ...
  return (<>
    <div className="lg:hidden flex items-center justify-between h-14 px-4 border-b border-current/10 sticky top-0 z-50 bg-stone-50">
    ...
    {mobileOpen && (
      <div className="lg:hidden fixed inset-0 z-50 flex">
        ...
        <div className="relative w-60 shadow-2xl border-r bg-stone-50" >{sideContent}</div>
      </div>
    )}
    <div className="hidden lg:flex flex-col fixed left-0 top-0 h-screen w-60 border-r border-current/10 z-40 bg-stone-50">
      {sideContent}
    </div>
