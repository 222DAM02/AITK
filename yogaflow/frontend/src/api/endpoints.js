...
export const itemsAPI = {
  ...
  getPoses: (id) => api.get(`/items/${id}/poses/`),
  addPose: (id, data) => api.post(`/items/${id}/poses/`, data),
  deletePose: (id, poseId) => api.delete(`/items/${id}/poses/${poseId}/`),
  reorderPose: (id, poseId, direction) => api.patch(`/items/${id}/poses/${poseId}/`, { direction }),
