  ...
  return (<div>
    ...
    <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-24">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {[
          { icon: '👨‍⚕️', title: '10 специализаций', desc: 'Терапевт, хирург, стоматолог, кардиолог и другие врачи' },
          { icon: '📅', title: 'Онлайн-запись', desc: 'Записывайтесь на приём к врачу с выбором даты и времени' },
          { icon: '🤖', title: 'AI + RAG', desc: 'AI-регистратура на основе медицинских данных из Wikipedia' },
        ].map((f, i) => (
