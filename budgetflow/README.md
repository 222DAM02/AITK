...
Управление личными финансами: доходы, расходы и бюджеты
...
- **Данные:** ExchangeRate API — курсы 15+ валют + Wikipedia финансы

## 📋 Функционал

**Пользователь:** регистрация, вход, CRUD (транзакция), дашборд с графиками, AI-чат, история
