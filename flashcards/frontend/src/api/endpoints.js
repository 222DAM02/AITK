...
export const itemsAPI = {
  ...
  // Cards
  getCards: (deckId) => api.get(`/items/${deckId}/cards/`),
  addCard: (deckId, data) => api.post(`/items/${deckId}/cards/`, data),
  deleteCard: (deckId, cardId) => api.delete(`/items/${deckId}/cards/${cardId}/`),
  // Study
  finishStudy: (deckId, data) => api.post(`/items/${deckId}/finish_study/`, data),
